        ...
        config = function()
            vim.api.nvim_create_autocmd("LspAttach", {
                ...
                callback = function(event)
                    ...
                    vks("<leader>dn", vim.diagnostic.jump({count=1, float=true}), "Go to next diagnostic")
                    vks("<leader>dp", vim.diagnostic.jump({count=-1, float=true}), "Go to previous diagnostic")
                    vks("<leader>dN", vim.diagnostic.jump({count=-1, float=true}), "Go to previous diagnostic (alternative to <leader>dn)")
