        ...
        config = function()
            vim.api.nvim_create_autocmd("LspAttach", {
                ...
                callback = function(event)
                    ...
                    vks("<leader>dn", function() vim.diagnostic.jump({count=1, float=true}) end, "Go to next diagnostic")
                    vks("<leader>dp", function() vim.diagnostic.jump({count=-1, float=true}) end, "Go to previous diagnostic")
                    vks("<leader>dN", function() vim.diagnostic.jump({count=-1, float=true}) end, "Go to previous diagnostic (alternative to <leader>dn)")
